    ...
    <li class="nav-item">
      <div class="btn-group nav-link">
        ...
        <div class="dropdown-menu" role="menu">
          <a class="dropdown-item" href="<?php echo base_url . 'admin/?page=user' ?>"><span class="bx bx-user bx-fx"></span> My Account</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="<?php echo base_url . '/classes/Login.php?f=logout' ?>"><span class="bx bx-log-out bx-fx"></span> Logout</a>
        </div>
      </div>
    </li>
    <li class="nav-item">
