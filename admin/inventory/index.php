        ...
        <div class="container-fluid">
            <table class="table table-bordered table-stripped" id="indi-list">
                ...
                <tbody>
                    <?php
                    $i = 1;
                    $qry = $conn->query("SELECT * from `inventory` order by unix_timestamp(date_created) desc ");
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="m-o truncate"><?php echo $row['description'] ?></p>
                            </td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#add_new').click(function() {
            uni_modal("<i class='fa fa-plus'></i>Add New", 'inventory/manage_inventory.php');
        })
        $('.edit_data').click(function() {
            uni_modal("<i class='fa fa-edit'></i>Edit This", 'inventory/manage_inventory.php?id=' + $(this).attr('data-id'));
        })
        $('.delete_data').click(function() {
            _conf("Are you sure to delete this?", "delete_inventory", [$(this).attr('data-id')])
        })
    })
